    ...
    <div class="footer-grid">
        ...
        <div>
            ...
            <div style="display: flex; gap: 10px; align-items: center; margin-top: 15px;">
                <img src="<?= BASE_URL ?>/assets/images/logotipo-sec.webp" alt="Superintendencia de Electricidad y Combustibles" style="height: 32px; filter: brightness(1.2);">
        ...
        <div>
            <h4 class="footer-heading">Servicios y Especialidades</h4>
        ...
        <div>
            <h4 class="footer-heading">Atención y Contacto</h4>
            ...
            <div style="margin-bottom: 16px;">
                <a href="tel:<?= PHONE_RAW ?>" style="font-family: var(--font-display); font-size: 1.25rem; font-weight: 800; color: #ffffff; text-decoration: none; display: flex; align-items: center; gap: 8px;">
                    <span style="color: var(--sec-green);">📞</span> <?= PHONE_DISPLAY ?>
                </a>
            </div>
            <a href="https://api.whatsapp.com/send?phone=56949877316&text=<?= urlencode('Hola Domingo, me comunico desde tu sitio web domingoisain.cl') ?>" target="_blank" class="btn-primary" style="padding: 10px 18px; font-size: 0.88rem; width: 100%; justify-content: center;">
                Escribir a WhatsApp
            </a>
