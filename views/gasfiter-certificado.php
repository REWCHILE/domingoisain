        ...
        <div class="hero-visual-pane">
            <div class="hero-visual-card" id="cert-slider-card">
                ...
                <div class="hero-floating-badge sec-credential-card">
                    <a href="<?= SEC_PORTAL_URL ?>" target="_blank" rel="noopener noreferrer" class="sec-qr-anchor sec-qr-container" title="Escanear con tu cámara o hacer clic para verificar en la SEC" aria-label="Código QR oficial de verificación SEC">
                        <picture>
                            ...
                            <img src="<?= BASE_URL ?>/assets/images/qr-sec-oficial.webp" alt="Código QR Validación SEC Domingo Isaín" width="110" height="110" class="sec-qr-image" loading="lazy" decoding="async">
                        </picture>
                        <span class="sec-qr-hint">📷 Escanear QR</span>
                    </a>
                    <div class="sec-badge-content">
                        ...
                        <div class="badge-info-sub">Instalador Autorizado SEC · RUT 12.738.961-6</div>
